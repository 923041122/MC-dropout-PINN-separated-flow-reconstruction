...
# ---------------------------------------------------------------------
# Reviewer-requested ResNet-type PINN baseline: evaluation registration
# Training/protocol are unchanged. This entry only allows the frozen
# ResNet checkpoint to be loaded by held-out/validation evaluators.
# ---------------------------------------------------------------------
HUMP_METHODS["resnet_pinn"] = {
